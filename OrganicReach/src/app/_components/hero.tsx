...
export function Hero(){
    return(
        <section className="relative text-white overflow-hidden bg-[url('/hero1.png')] bg-cover bg-center bg-no-repeat before:absolute before:inset-0 before:bg-black before:opacity-40">
